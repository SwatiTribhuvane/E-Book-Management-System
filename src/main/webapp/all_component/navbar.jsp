...
<div class="row">
	<div class="col-md-3 text-success">
		<h3><i class="fa-solid fa-book"></i> Eager e-Books</h3>
	</div>
		<div class="col-md-6">
			...
			<a href="checkout.jsp"><i class="fa-solid fa-cart-plus fa-2x"></i>
			</a>		
...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0">
      ...
      <i class="fa-sharp fa-solid fa-gear"></i> Setting</a>
      
      <a href="contactus.jsp" class="btn btn-light my-2 my-sm-0 ml-1" type="submit">
      <i class="fa-sharp fa-solid fa-square-phone"></i> Contact Us</a>
